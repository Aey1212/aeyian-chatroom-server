...
| username<sup>2</sup> | Username registry |
...
| list_locked_usernames | The locked usernames were listed |
...
| list_username_change_requests | The pending rename requests were listed |
...
| approve_username_change_request | A rename request was approved and the account renamed |
...
| change_username | An admin renamed an account directly |
| clear_fields<sup>1</sup> | Profile fields of an account, or fields of a guild, were cleared |
| close_password_reset | An open password reset was closed |
...
| open_password_reset | A password reset was opened for an account |
...
| reject_username_change_request | A rename request was rejected and its username given back |
| release_locked_username | A locked username was released for registration |
...
| user:update:email | Changes and verifies the email address, resends verification, and sends or opens a password reset |
...
| user:update:username | Renames accounts, decides rename requests, and lists and releases locked usernames |
